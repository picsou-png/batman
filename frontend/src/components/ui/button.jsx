  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary text-secondary-foreground shadow-soft hover:shadow-medium hover:bg-secondary/90 active:scale-[0.98]",
        ghost: 
          "hover:bg-muted hover:text-foreground active:scale-[0.98]",
        link: 
          "text-secondary underline-offset-4 hover:underline",
        success:
          "bg-success text-success-foreground shadow-soft hover:shadow-glow-success hover:bg-success/90 active:scale-[0.98]",
        danger:
          "bg-danger text-danger-foreground shadow-soft hover:shadow-glow-danger hover:bg-danger/90 active:scale-[0.98]",
        hero:
          "bg-accent text-accent-foreground shadow-medium hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] font-semibold",
        heroOutline:
